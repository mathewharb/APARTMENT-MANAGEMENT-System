...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 17, 2021 at 12:58 AM
...
DROP TABLE IF EXISTS `tbl_bed_assign`;
CREATE TABLE IF NOT EXISTS `tbl_bed_assign` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tbl_complaint_cat`;
CREATE TABLE IF NOT EXISTS `tbl_complaint_cat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tbl_dhpms_options`;
CREATE TABLE IF NOT EXISTS `tbl_dhpms_options` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'dhp_name', 'Harbs Hostels'),
(2, 'app_footer', 'HarbCreation © 2021'),
(8, 'app_version', '3.0.0'),
(9, 'tid_start', '100'),
(10, 'currency_code', 'GMD'),
(11, 'currency_symbol', 'D'),
(12, 'rid_start', '100'),
(13, 'contact_no', '002207425159'),
(14, 'email', 'harbmathew@yahoo.com'),
(15, 'country', 'Gambia'),
(16, 'state', 'KMC'),
(17, 'city', 'Kanifing'),
(18, 'address', 'Kanifing Estte'),
(19, 'bid_start', '105'),
(20, 'tax_name', 'GST1'),
(21, 'tax_per', '18'),
(22, 'tax_apply', '1'),
...
(34, 'smtp_port', ''),
(35, 'paypal_email', ''),
(36, 'app_logo', '5ef82ab1ee72b5f0f85bbf1c7617ecd4.png'),
(37, 'stripe_secret_key', ''),
(38, 'stripe_publishable_key', ''),
(39, 'lang', 'english'),
(40, 'tax_num_label', 'GST3'),
(41, 'tax_num', 'XXXXXXXXXXXXX'),
(42, 'invoice_footer', 'This is the invoice footer, you can edit this from configurations.'),
...
(1, 'email_tenant_create', 'Hello {{ten_name}},\r\n\r\nYour account is successfully created in {{dhp_name}} - HBHMS system.\r\nYou can log in now with bellow credentials:\r\n\r\nEmail: {{ten_email}}\r\n\r\nPassword: {{ten_email}}\r\n\r\nYou can change your password by logging into your account.\r\n\r\n&nbsp;\r\n\r\nThank You,\r\n\r\n{{dhpm_name}} - HBHMS\r\n'),
(2, 'room_asigned', 'Hello {{ten_name}},\r\n\r\nPlease find below details about your accommodation at {{dhpm_name}},\r\n\r\n\r\n	\r\n		\r\n			Room Name\r\n			{{room_name}}\r\n		\r\n		\r\n			Bed Name\r\n			{{bed_name}}\r\n		\r\n		\r\n			Total Amount\r\n			{{total_amount}}\r\n		\r\n		\r\n			Invoice Status\r\n			{{invoice_status}}\r\n		\r\n	\r\n\r\n\r\n\r\nPlease log in to your account for invoice details.\r\n\r\n&nbsp;\r\n\r\nThank You,\r\n\r\n{{dhpm_name}} - HBHMS\r\n'),
(3, 'es_assigned', 'Hello {{ten_name}},\r\n\r\nPlease find below details about your extra service at {{dhpm_name}},\r\n\r\n\r\n	\r\n		\r\n			Extra Service Name\r\n			{{es_name}}\r\n		\r\n		\r\n			Total Amount\r\n			{{total_amount}}\r\n		\r\n		\r\n			Invoice Status\r\n			{{invoice_status}}\r\n		\r\n	\r\n\r\n\r\n\r\nPlease log in to your account for invoice details.\r\n\r\n&nbsp;\r\n\r\nThank You,\r\n\r\n{{dhpm_name}} - HBHMS\r\n'),
(4, 'add_payment', 'Hello {{ten_name}},\r\n&nbsp;\r\n\r\nWe have received a payment of {{pay_amnt}} against the Invoice no. {{inv_number}} on {{pay_date}}.\r\n\r\nPlease log in to your account for invoice details.\r\n\r\n&nbsp;\r\n\r\nThank You,\r\n\r\n{{dhpm_name}} - HBHMS\r\n');
...
DROP TABLE IF EXISTS `tbl_es_assign`;
CREATE TABLE IF NOT EXISTS `tbl_es_assign` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tbl_extra_services`;
CREATE TABLE IF NOT EXISTS `tbl_extra_services` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, '5ae68-1593837721.jpg', 'Welcome to Harbs Hostel', 1),
(2, 'dca6a-slider5.jpg', 'Your Hostel management software', 1),
(3, '20279-remodelling.jpg', 'Ultimate Application for Multiple Branches', 1);
...
CREATE TABLE IF NOT EXISTS `tbl_invoice_payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inv_id` varchar(125) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_tenants` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ten_uid` (`ten_uid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(2, 'admin@admin.com', '2020-02-17', '2021-05-17 00:56:34', 'Super Administrator', '5f4dcc3b5aa765d61d8327deb882cf99', 'admin', '1'),
(8, 'branch@harbs.com', '2020-02-23', '2021-05-04 12:32:06', 'Branch', '5f4dcc3b5aa765d61d8327deb882cf99', 'branch admin', '1'),
(9, 'admin@harbs.com', '2020-06-02', '2021-05-04 12:32:31', 'Administrator', '5f4dcc3b5aa765d61d8327deb882cf99', 'admin', '');
...
DROP TABLE IF EXISTS `tbl_utility_bill_cat`;
CREATE TABLE IF NOT EXISTS `tbl_utility_bill_cat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tbl_web_pages`;
CREATE TABLE IF NOT EXISTS `tbl_web_pages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
