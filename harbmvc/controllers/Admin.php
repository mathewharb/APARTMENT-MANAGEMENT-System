...
class Admin extends BaseController {
	...
	{
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['signin']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['errmsg'] = $errmsg;
	...
	{
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['register']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['errmsg'] = $errmsg;
		$data['branches'] = $this->admin_model->getAllBranches();
	...
	function changepassword()
	{
		$this->chkLogin(false);
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['changepassword']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function dashboard()
	{
		$this->chkLogin(false);
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['dashboard']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function tenant($tenuid,$view='admin')
	{
		...
		$data['title'] = ucfirst($this->lan['tenant'].' '.$this->lan['profile']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'tenants';
		$data['burl'] = $this->burl;
		$data['tenuid'] = $tenuid;
		$data['view'] = $view;
	...
	function tenants($target = '', $tenuid = '')
	{
            ...
            else 
            {
                ...
                $data['title'] = ucfirst($this->lan['tenants']." - ".$data['options']['dhp_name']." | HarbCreation");
                $data['cpage'] = 'tenants';
	...
	function newtenant()
	{
		...
		$data['branches'] = $this->admin_model->getAllBranches();
		$data['title'] = ucfirst($this->lan['new'].' '.$this->lan['tenant']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function edittenant($tenuid)
	{
		...
		$data['userdata'] = $this->session->userdata;
		$data['tendata'] = $this->admin_model->getTenantDetails($tenuid);
		$data['title'] = ucfirst($this->lan['edit'].' '.$this->lan['tenant']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'newtenant';
		$data['burl'] = $this->burl;
        $data['tenuid'] = $tenuid;
		$this->load->view('backend/common/header',$data);
	...
	function assignTenantBed($tenuid)
	{
		...
		$data['title'] = ucfirst($this->lan['assign'].' '.$this->lan['bed']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'newtenant';
		$data['tenuid'] = $tenuid;
		$this->load->view('backend/common/header',$data);
	...
	function newinvoice()
	{
		...
		$data['notify_type'] = 'success';
		$data['title'] = ucfirst($this->lan['generate'].' '.$this->lan['invoice']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'invoices';
		$this->load->view('backend/common/header',$data);
	...
	function rooms($target = '', $roomuid = '')
	{
            ...
            else 
            {
                ...
                $data['title'] = ucfirst($this->lan['rooms']." - ".$data['options']['dhp_name']." | HarbCreation");
                $data['cpage'] = 'rooms';
	...
	function newroom()
	{
		$this->chkLogin();
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['new'].' '.$this->lan['room']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'newroom';
		$this->load->view('backend/common/header',$data);
	...
	function editroom($roomuid)
	{
		...
		$data['title'] = ucfirst($this->lan['edit'].' '.$this->lan['room']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'editroom';
	...
	function roomstructure($roomuid)
	{
		...
		$data['title'] = ucfirst($this->lan['room'].' '.$this->lan['structure']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'rooms';
		$data['roomuid'] = $roomuid;
		$this->load->view('backend/common/header',$data);
	...
	function beds($target = '', $beduid = '',  $tenuid = '', $reqid = '')
	{
            ...
            {
				$data['options'] = $this->gmsOptions();
				$data['title'] = ucfirst($this->lan['beds']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function newbed()
	{
		...
		$data['options'] = $this->gmsOptions();
		$data['allrooms'] = $this->admin_model->getAllRooms($this->branchid);
		$data['title'] = ucfirst($this->lan['new'].' '.$this->lan['bed']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'newbed';
		$this->load->view('backend/common/header',$data);
	...
	function editbed($beduid)
	{
		...
		$data['title'] = ucfirst($this->lan['edit'].' '.$this->lan['bed']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'newbed';
		$data['beduid'] = $beduid;
		$this->load->view('backend/common/header',$data);
		$this->load->view('backend/newbed',$data);
	...
	function requestbed()
	{
		...
		$data['allrooms'] = $this->admin_model->getAllRooms($this->branchid);
		$data['allbeds'] = $this->admin_model->getAllBeds();
		$data['title'] = ucfirst($this->lan['requestbed']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function requestes()
	{
		...
		$data['title'] = ucfirst($this->lan['requestes']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['tenuid'] = $this->session->userdata['user_id'];
		$data['cpage'] = 'makerequest';
		$this->load->view('backend/common/header',$data);
	...
	function allrequests()
	{
		$this->chkLogin(false);
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['allrequests']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['tenuid'] = $this->session->userdata['user_id'];
		$usertype = $this->session->userdata['user_type'];
	...
	function extraservices($target = '', $extraservicesuid = '',  $tenuid = '', $reqid = '')
	{
            ...
            else 
            {
                ...
                $data['title'] = ucfirst($this->lan['extraservices']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function assignextraservices($esid,$tenuid,$reqid)
	{
		...
		$data['title'] = ucfirst($this->lan['assign'].' '.$this->lan['extraservice']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function newextraservice()
	{
		$this->chkLogin();
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['new'].' '.$this->lan['extraservice']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'newextraservice';
		$this->load->view('backend/common/header',$data);
	...
	function editextraservice($esid)
	{
		...
		$data['allrooms'] = $this->admin_model->getAllRooms();
		$data['esdata'] = $this->admin_model->getEsDetails($esid);
		$data['title'] = ucfirst($this->lan['edit'].' '.$this->lan['extraservice']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'newextraservice';
	...
	function invoices()
	{
		...
		$data['title'] = ucfirst($this->lan['invoices']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'invoices';
		$invoice_list_msg = $this->session->flashdata('invoice_list_msg');
		$data['notify_msg'] = isset($invoice_list_msg) ? $invoice_list_msg : '';
		$data['notify_type'] = 'success';
	...
	function invoice($inv_id)
	{
		...
		$data['title'] = ucfirst($this->lan['invoice']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'invoices';
		$invoice_list_msg = $this->session->flashdata('invoice_list_msg');
		$data['notify_msg'] = isset($invoice_list_msg) ? $invoice_list_msg : '';
		$data['notify_type'] = 'success';
	...
	function users()
	{
		...
		$gdata['title'] = ucfirst($this->lan['users']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'users';
	...
	function branches()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['branches']." - ".$gdata['options']['dhp_name']." | HarbCreation");
	...
	function expensecat()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['expense'].' '.$this->lan['categories']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'settings';
	...
	function ubillcat()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst("utility bill categories - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'settings';
	...
	function complaintcat()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['complaint'].' '.$this->lan['categories']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'settings';
	...
	function idcat()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst("ID Document categories - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'settings';
	...
	function emailtpl()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['email'].' '.$this->lan['templates']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'settings';
	...
	function webpages()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['web'].' '.$this->lan['pages']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'website';
	...
	function blog()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['blog']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'website';
	...
	function gallery()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['gallery']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'website';
	...
	function events()
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['events']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'events';
	...
	function filemanager()
	{
		$this->chkLogin(false);
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['filemanager']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'website';
		$data['connector'] = site_url() . '/admin/connector';
		$dash_msg = $this->session->flashdata('dash_msg');
		$data['notify_msg'] = isset($dash_msg) ? $dash_msg : '';
	...
	function about()
	{
		$this->chkLogin(false);
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['aboutus']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'aboutus';
		$dash_msg = $this->session->flashdata('dash_msg');
		$data['notify_msg'] = isset($dash_msg) ? $dash_msg : '';
		$data['notify_type'] = 'success';
	...
	function notices($view = 'admin')
	{
		...
		$this->load->library('grocery_CRUD');
		$gdata['options'] = $this->gmsOptions();
		$gdata['title'] = ucfirst($this->lan['notices']." - ".$gdata['options']['dhp_name']." | HarbCreation");
		$gdata['cpage'] = 'notices';
		$gdata['userdata'] = $this->session->userdata;
	...
	function payments($target = '', $paymentuid = '')
	{
            ...
            {
				$data['options'] = $this->gmsOptions();
                $data['title'] = ucfirst($this->lan['payments']." - ".$data['options']['dhp_name']." | HarbCreation");
				$data['cpage'] = 'payments';
	...
	function newpayment()
	{
		...
		$data['title'] = ucfirst($this->lan['new'].' '.$this->lan['payment']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function makepayment()
	{
		...
		$data['title'] = ucfirst($this->lan['make'].' '.$this->lan['payment']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'payments';
		$payment_list_msg = $this->session->flashdata('payment_list_msg');
		$data['notify_msg'] = isset($payment_list_msg) ? $payment_list_msg : '';
		$data['notify_type'] = 'success';
	...
	function expenses($target = '', $expenseuid = '')
	{
			...
			$this->load->library('grocery_CRUD');
			$gdata['options'] = $this->gmsOptions();
			$gdata['title'] = ucfirst($this->lan['expenses']." - ".$gdata['options']['dhp_name']." | HarbCreation");
	...
	function newexpense()
	{
		$this->chkLogin();
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['new'].' '.$this->lan['expense']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'newpayment';
		$this->load->view('backend/common/header',$data);
	...
	{
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['income'].' '.$this->lan['report']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'report';
	...
	{
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['expense'].' '.$this->lan['report']." - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'report';
		$incomereport_list_msg = $this->session->flashdata('incomereport_list_msg');
		$data['notify_msg'] = isset($incomereport_list_msg) ? $incomereport_list_msg : '';
		$data['notify_type'] = 'success';
	...
	{
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst("prpt report - ".$data['options']['dhp_name']." | HarbCreation");
		$data['cpage'] = 'report';
	...
	function configurations()
	{
		$this->chkLogin();
		$data['options'] = $this->gmsOptions();
		$data['title'] = ucfirst($this->lan['configurations']." - ".$data['options']['dhp_name']." | HarbCreation");
	...
	function complaints()
	{
		...
		$data['options'] = $this->gmsOptions();
		$data['userdata'] = $this->session->userdata;
		$data['title'] = ucfirst($this->lan['complaints']." - ".$data['options']['dhp_name']." | HarbCreation");
