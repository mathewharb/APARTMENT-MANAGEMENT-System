...
class Website extends BaseController {
    ...
    function index()
    {
      ...
      $data['options'] = $this->gmsOptions();
      $data['title'] = ucfirst($data['options']['dhp_name']." | HarbCreation");
    ...
    function page($slug)
    {
      ...
      $data['title'] = ucfirst($data['webpage']['web_page_name']." | ".$data['options']['dhp_name']." | HarbCreation");
      $data['webpages'] = $this->admin_model->getWebPages();
    ...
    function contact()
    {
      $this->load->library('parser');
      $data['options'] = $this->gmsOptions();
      $data['title'] = ucfirst("Contact Us | ".$data['options']['dhp_name']." | HarbCreation");
      $data['webpages'] = $this->admin_model->getWebPages();
    ...
    function blog()
    {
      $this->load->library('parser');
      $data['options'] = $this->gmsOptions();
      $data['title'] = ucfirst("Blog | ".$data['options']['dhp_name']." | HarbCreation");
      $data['webpages'] = $this->admin_model->getWebPages();
