...
<head>
  ...
  <meta name="description" content="HMS is a complete all in one  Hostel Management Software.">
  <meta name="author" content="HMS - HarbCreation">

  <title><?php echo $options['dhp_name']; ?> - HMS </title>
...
<body id="page-top">
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; <?php echo $options['dhp_name']; ?> - Powered by HarbCreation</p>
    </div>
    <!-- /.container -->
  </footer>
