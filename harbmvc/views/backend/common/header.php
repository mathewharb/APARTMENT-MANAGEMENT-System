...
<div class="wrapper">
  ...
  <aside class="main-sidebar elevation-4 sidebar-light-indigo">
    ...
    <img src="<?php echo base_url(); ?>assets/backend/dist/img/harbcreation2.png" alt="HBHMS Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">HarbCreation</span>
    </a>
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <?php if(isset($userdata) && $userdata['user_type'] != 'member') { ?>
        <li class="nav-item"><a href="https://github.com/mathewharb/" target="_blank" class="nav-link">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3 class="text_center">Hostel Management System</h3><hr/>
        <p class="floatright"><?php echo $lang['version']; ?>: <b><?php echo $options['app_version']; ?></b></p><br><br>
        &copy; 2021 .<br>
        <img src="<?php echo base_url(); ?>assets/backend/dist/img/harbcreation.png" class="text_center width20">
      </div>
