        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <tr><td><b>System Name</b></td><td>Hostel Management System</td></tr>
                <tr><td><b><?php echo $lang['version']; ?></b></td><td><?php echo $options['app_version']; ?></td></tr>
                <tr><td colspan=2><center>Made with <i class="fas fa-heart"></i> Harb.</center></td></tr>
                <tr><td colspan=2><center><img src="<?php echo base_url(); ?>assets/backend/dist/img/harbcreation.png" class="text_center width20"></center></td></tr>
                </table>
            </div>
            <!-- /.box-body -->
          </div>
